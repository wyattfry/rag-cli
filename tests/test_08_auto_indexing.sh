...
rag_cli --auto-approve --auto-index --prompt 'create a file called auto_test.py with content "# Auto-index test file"' >"$auto_index_test_file" 2>&1
...
rag_cli --auto-approve --auto-index --prompt 'create a log file called test.log' >"$filter_test_file" 2>&1
...
rag_cli --auto-approve --auto-index --prompt 'create files: test.txt with "hello" and test.py with "print(1)"' >"$multi_test_file" 2>&1
