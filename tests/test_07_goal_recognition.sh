...
rag_cli chat --auto-approve --prompt 'show me the current working directory path' >"$goal_test_file" 2>&1
...
rag_cli chat --auto-approve --prompt 'count the number of files in the current directory' >"$filtering_test_file" 2>&1
...
rag_cli chat --auto-approve --prompt 'display the current date' >"$evaluation_test_file" 2>&1
